...
\input{editaveis/fundamentacao.tex}
\input{editaveis/MUDs.tex}
\input{editaveis/evolucaoManutencaoDeSoftware.tex}
\input{editaveis/metodologia.tex}
\input{editaveis/resultadosParciais.tex}
\input{editaveis/dyrt.tex}
\input{editaveis/simpleMUD}
